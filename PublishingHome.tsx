      ...
      <header className={`sticky top-0 z-40 border-b backdrop-blur-xl transition-all ${dark ? 'border-white/10 bg-[#090D15]/92' : 'border-[#0E1420]/10 bg-[#FAF7F2]/92'}`}>
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-3.5">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            <a href="#/articles" className="inline-flex items-center gap-1.5 rounded-full border border-[#C8862A]/40 bg-[#C8862A]/10 px-3.5 py-1.5 font-[JetBrains_Mono] text-[10px] font-bold uppercase tracking-[0.14em] text-[#C8862A] no-underline transition-all hover:bg-[#C8862A] hover:text-[#0E1420]">
              📰 Articles
            </a>
          </nav>
